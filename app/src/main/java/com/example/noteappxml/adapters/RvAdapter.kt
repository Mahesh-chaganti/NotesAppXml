...
import com.example.noteappxml.databinding.NoteItemLayoutBinding
import com.example.noteappxml.fragments.NoteFragmentDirections
         ...
         //   .usePlugin(StrikethroughPlugin.create())
            ...
            .usePlugin(object: AbstractMarkwonPlugin(){
                override fun configureVisitor(builder: MarkwonVisitor.Builder) {
                    ...
                    builder.on(
                        SoftLineBreak::class.java){visitor, _ -> visitor.forceNewLine() }
                }
            })
            .build()
    }
